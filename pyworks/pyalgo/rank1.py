...
i=1, j=0 score[1] < score[0] True rank[0]=2
     j=1 score[1] < score[1] False rank[0]=2
     j=2 score[1] < score[2] True rank[1]=3
     j=3 score[1] < score[3] True rank[0]=4
     j=4 score[1] < score[4] True rank[0]=5
     j=5 score[1] < score[5] True rank[0]=6(순위 확정)
i=2, j=0 score[2] < score[0] True rank[2]=2
     j=1 score[2] < score[1] True rank[2]=2
     j=2 score[2] < score[2] True rank[2]=2
     j=3 score[2] < score[3] True rank[2]=2
